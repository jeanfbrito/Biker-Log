...
class CalibrationManager {
    ...
    private class SampleCollector {
        ...
        fun addSample(accel: FloatArray, gyro: FloatArray, mag: FloatArray) {
    ...
    fun applyCalibration(input: FloatArray, sensorType: Int): FloatArray {
