 ...
 */
class BarInclinometerView @JvmOverloads constructor(
    context: Context,
    ...
    private fun drawCenterTarget(canvas: Canvas, centerX: Float, centerY: Float) {
        // Draw center circle
    ...
    private fun drawVerticalPitchBar(canvas: Canvas, x: Float, y: Float, width: Float, height: Float) {
        // Draw background
    ...
    private fun drawHorizontalRollBar(canvas: Canvas, x: Float, y: Float, width: Float, height: Float) {
        // Draw background
        barBackgroundPaint.color = barBackgroundColor
        canvas.drawRect(x, y, x + width, y + height, barBackgroundPaint)
    ...
    private fun drawDigitalReadouts(canvas: Canvas, width: Float, height: Float) {
