...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun addSamplingRateSetting(layout: LinearLayout) {
        ...
        samplingRateSpinner =
            Spinner(this).apply {
                adapter =
                    ArrayAdapter(this@SettingsActivity, android.R.layout.simple_spinner_dropdown_item, rates).apply {
