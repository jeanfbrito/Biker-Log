...
class SamplingRateOptimizationTest {
    ...
    @Test
    fun `default sampling rate should be 50Hz for optimization`() =
        runBlocking {
    ...
    @Test
    fun `sampling rate can be changed to supported values`() =
        runBlocking {
    ...
    fun `sampling period calculation is correct`() {
        val testCases =
            mapOf(
                ...
                50 to 20000,
                // 100 Hz = 10,000 microseconds
                100 to 10000,
                // 200 Hz = 5,000 microseconds
                200 to 5000,
            )
    ...
    @Test
    fun `settings persist after app restart`() =
        runBlocking {
            // Set custom rate
